<?php
return [
    'transfer.same_wallet.unauthorized'    => 'It is not allowed to transfer to your wallet.',
    'transfer.store_owner.unauthorized'    => 'Store owner is not allowed to send money.',
    'transfer.value.insufficient_funds'    => 'Insufficient funds',
    'transfer.value.required'              => 'Value is required',
    'transfer.value.min'                   => 'Please enter a minimum value of 0.01.',
